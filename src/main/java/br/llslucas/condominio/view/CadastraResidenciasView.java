 ...
 * @author Lucas
 */
public class CadastraResidenciasView extends javax.swing.JPanel {
   ...
   */
  public CadastraResidenciasView(CondominioController condominioController, ResidenciaController residenciaController, MoradorController moradorController) {
    initComponents();
  ...
  public void setVisible(boolean aFlag) {
	...
	this.condominioController.list().forEach((i, condominio) -> {
	  fCondominio.addItem(condominio);
	});
      } catch (Exception ex) {
  ...
  private void initComponents() {
    ...
    jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Cadastro de Residência"));
  ...
  private void btnCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCadastrarActionPerformed
    ...
    Residencia condominio = new Residencia(rua, numero, cep, tipo, proprietarioId, condominioId);

    try {
      this.residenciaController.create(condominio);
      JOptionPane.showMessageDialog(this, "Residência cadastrado com sucesso!");
      fRua.setText("");
      fNumero.setText("");
      fCep.setText("");
      fTipo.setText("");
      ...
      JOptionPane.showMessageDialog(this, "Falha ao cadastrar residência, verifique o erro abaixo: \n" + ex.getMessage());
    }
